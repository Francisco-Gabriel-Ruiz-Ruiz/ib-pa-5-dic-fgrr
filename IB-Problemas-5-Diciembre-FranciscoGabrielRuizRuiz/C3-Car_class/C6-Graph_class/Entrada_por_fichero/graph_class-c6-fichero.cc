 ...
 * @param[out] output_file The file that the program will write to
 **/
 ...
 * @param[in] graph_vertexes The total amount of vertexes (passed by reference)
 *                        the graph will have
 * @param[in] graph_edges The total amount of edges (passed by reference)
 *                    the graph will have
 * @param[in] user_input_file The file that the program will read
 **/
 ...
 * @param[in] user_file_name The user file name that will be checked now.
 * @param[in] user_file The user file that will be later read and checked now.
